    ...
    <Content>
      <Row>
        <Col span={24}>
          ...
          <br/>
          <Typography>
            <Title level={3} style={{textAlign: "center"}}>KHOÁ HỌC CỦA CHÚNG TÔI</Title>
          </Typography>
          <Divider />
          <Col span={12}>
            <Search
            ...
            renderItem={item => (
              <List.Item>
                <Card
                  hoverable
                  style={{ width: '99%' }}
                  cover={<img alt="example" src="https://thietkeweb5ngay.com/wp-content/uploads/2019/06/lap-trinh-node-js_m_1555658280.jpg" />}
                >
                  <Meta title="Lập trình NodeJs" description="CNTT" />
                  <br/>
